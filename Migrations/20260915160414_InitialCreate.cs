...
namespace ProcessTracker.API.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProcessDefinitionProjectMappings",
                columns: table => new
                {
                    ProcessDefinitionId = table.Column<int>(type: "int", nullable: false),
                    ProjectId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessDefinitionProjectMappings", x => new { x.ProcessDefinitionId, x.ProjectId });
                    table.ForeignKey(
                        name: "FK_ProcessDefinitionProjectMappings_ProcessDefinitions_ProcessDefinitionId",
                        column: x => x.ProcessDefinitionId,
                        principalTable: "ProcessDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProcessDefinitionProjectMappings_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceItems_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceItems_ProcessDefinitions_ProcessDefinitionId",
                        column: x => x.ProcessDefinitionId,
                        principalTable: "ProcessDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProcessRecord_DataJson", "ISJSON(DataJson) = 1");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProcessRecords_ServiceItems_ServiceItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessDefinitionProjectMappings_ProjectId",
                table: "ProcessDefinitionProjectMappings",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessFields_ProcessDefinitionId_FieldName",
                table: "ProcessFields",
                columns: new[] { "ProcessDefinitionId", "FieldName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessRecords_ServiceItemId",
                table: "ProcessRecords",
                column: "ServiceItemId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServiceItems_ApplicationId",
                table: "ServiceItems",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceItems_ProcessDefinitionId",
                table: "ServiceItems",
                column: "ProcessDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceItems_ReferenceNumber",
                table: "ServiceItems",
